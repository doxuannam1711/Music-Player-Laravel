    ...
    songs: [
        {
            ...
            singer: "Second man",
            path: "/musics/1sec.mp3",
            image: "/img/1sec.png",
        },
        {
            name: "Lạ Lùng",
            singer: "Vũ",
            path: "/musics/Lạ_Lùng _Vũ.mp3",
            image: "/img/Vu_Ti_Hong.jpg",
        },
        {
            name: "Happy For You",
            singer: "Lukas Graham (feat Vũ)",
            path: "/musics/Lukas Graham Happy For You .mp3",
            image: "/img/HappyForYou.png",
        },
        {
            name: "Snowman",
            singer: "Sia",
        ...
        },
        {
            name: "My Love",
            singer: "West Life",
            path: "/musics/Westlife_MyLove.mp3",
            image: "/img/WestLife_MyLove.jpg",
        },
        {
            name: "I Do",
            singer: "911",
            path: "/musics/I_Do _911_Band.mp3",
            image: "/img/I_Do_911.jpg",
        },
        {
            name: "Beautiful in white",
            singer: "West Life",
            path: "/musics/Westlife_Beautiful in white.mp3",
            image: "/img/beautiful_in_white.png",
        },
        {
            name: "Just give me a reason",
            singer: "P!nk",
            path: "/musics/P!nk_Just Give Me A Reason ft Nate Ruess.mp3",
            image: "/img/Just_give_me_a_reason.jpg",
        },
        {
            name: "When You Tell Me That You Love Me",
            singer: "West Life with Diana Ross",
            path: "/musics/Westlife_When You Tell Me That You Love Me Official Video with Diana Ross.mp3",
            image: "/img/When You Tell Me That You Love Me Official Video with Diana Ross.png",
        },
        {
            name: "Soledad",
            singer: "West Life",
            path: "/musics/Westlife_Soledad.mp3",
            image: "/img/Soledad.jpg",
        },
        {
            name: "TO THE MOON",
            singer: "hooligan",
            path: "/musics/TO THE MOON_hooligan.mp3",
            image: "/img/TO THE MOON.jpg",
        },
        {
            name: "Talking To The Moon",
            singer: "Bruno Mars",
            path: "/musics/Bruno Mars_Talking To The Moon.mp3",
            image: "/img/Talking to the moon.jpg",
        },
        // {
        //     name: "",
        //     singer: "",
